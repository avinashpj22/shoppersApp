...
// Add Product Service dependencies (custom extension method)
builder.Services.AddProductServiceDependencies(builder.Configuration);
...
logger.LogInformation("Product Service starting on {Environment}", app.Environment.EnvironmentName);
